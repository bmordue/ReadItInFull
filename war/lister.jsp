...
<script type="text/javascript"
	src="https://www.google.com/jsapi?key=ABQIAAAA9l3qy-cONBbRT9UC7zeCSRRQGDklHMpeozCb8OrviK90TAIg_hS9P02k2kBczOAoOjD565m_bTaDmA"></script>
	...
	$(document).ready(
			function() {
				...
				$('#hidenames').click(function() {
					$('tr td:first-child').css('display', 'none');
				});
				...
				$('.pageno').click(function() {
					$('tbody#rows').load('/list?page=' + $(this).text());
				});
				...
				$(function() {
					$('.checkall').click(
							function() {
								$(this).parents('fieldset:eq(0)').find(
